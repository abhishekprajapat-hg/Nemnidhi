      ...
      <Container className="relative">
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-10">
          <div className="z-10 space-y-6 md:col-span-4">
            <p className="theme-pill w-fit">Immersive Growth Architecture</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          <div className="theme-card p-5 text-center">
            ...
            <p className="mt-1 text-sm text-[#AABFD4]">Brands trust Nemnidhi</p>
          </div>
          <div className="theme-card p-5 text-center">
            <p className="text-4xl font-bold text-[#69AEFF]">100%</p>
            <p className="mt-1 text-sm text-[#AABFD4]">Go-live commitment rate</p>
          </div>
          <div className="theme-card p-5 text-center">
            <p className="text-4xl font-bold text-[#69AEFF]">99%</p>
            <p className="mt-1 text-sm text-[#AABFD4]">Retention across programs</p>
          </div>
        </div>
      </Container>
    </section>
